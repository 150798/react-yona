...
import ModalTopup from '../../component/ModalTopup/ModalTopup';
                        ...
                        <div className="row gutters-sm">
                            <div className="col-md-3 mb-3">
                                ...
                                <div className="card mt-3">
                                    ...
                                    <button className="btn btn-warning" onClick={toogleModal1}>
                                        Top Up
                                        
                                        </button>
                                        {toogleModal? <ModalTopup2 /> : ""}
                                        <br />

                                        
                                    <button className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalsaldo1">
                                        Donasi</button><br />
